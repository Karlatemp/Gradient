 ...
 * @create 2020/07/06 15:12:34
 *
 * gradient/gradient.main/Vector.java
 */
...
public class Vector implements Cloneable, Serializable {
    ...
    /**
     * Performs scalar multiplication, divides the vector by another.
     *
     * @param d The factor
     * @return the same vector
     */
     ...
     */
    @NotNull
    public Vector rotateAroundAxis(@NotNull("The provided axis vector was null") Vector axis, double angle) throws IllegalArgumentException {
     ...
     */
    @NotNull
    public Vector rotateAroundNonUnitAxis(@NotNull("The provided axis vector was null") Vector axis, double angle) throws IllegalArgumentException {
